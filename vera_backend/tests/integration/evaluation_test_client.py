...
from vera_backend.models import EvaluationStatus
from vera_backend.routers.evaluation import router
from vera_backend.schemas.evaluation import EvaluationOutSchema, EvaluationDetailOutSchema, \
    EvaluationByStatusResponseSchema
from vera_backend.schemas.measure import MeasureOutSchema, MeasureInSchema
from vera_backend.schemas.project import ProjectDetailsOutSchema
...
async def create_evaluation(project_details: ProjectDetailsOutSchema, model_name: str, training_dataset_name: str) -> EvaluationOutSchema:
    with (
        patch("vera_backend.routers.evaluation.vera_backend.trigger_evaluation_task", new_callable=AsyncMock) as eval_response,
    ):
