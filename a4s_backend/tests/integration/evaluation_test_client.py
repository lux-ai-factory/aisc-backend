...
from a4s_backend.routers.evaluation import router
from a4s_backend.schemas.evaluation import EvaluationOutSchema, EvaluationDetailOutSchema, \
    EvaluationByStatusResponseSchema
from a4s_backend.schemas.measure import MeasureOutSchema, MeasureInSchema
from a4s_backend.schemas.project import ProjectDetailsOutSchema
...
async def create_evaluation(project_details: ProjectDetailsOutSchema, model_name: str, training_dataset_name: str) -> EvaluationOutSchema:
    with (
        patch("a4s_backend.routers.evaluation.a4s_eval.trigger_evaluation_task", new_callable=AsyncMock) as eval_response,
    ):
